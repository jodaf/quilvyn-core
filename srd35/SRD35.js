/* $Id: SRD35.js,v 1.57 2006/11/22 04:35:00 Jim Exp $ */
...
PH35.SPELLS = [
  'Acid Fog:W6/Wa7/Conj',
  'Acid Splash:W0/Conj',
  'Aid:C2/Go2/Lu2/Ench',
  'Air Walk:Ai4/C4/D4/Tran',
  'Alarm:B1/R1/W1/Abju',
  'Align Weapon:C2/Tran',
  'Alter Self:B2/W2/Tran',
  'Analyze Dweomer:B6/W6/Divi',
  'Animal Growth:D5/R4/W5/Tran',
  'Animal Messenger:B2/D2/R1/Ench',
  'Animal Shapes:An7/D8/Tran',
  'Animal Trance:B2/D2/Ench',
  'Animate Dead:C3/De3/W4/Necr',
  'Animate Objects:B6/C6/Ch6/Tran',
  'Animate Plants:D7/Pl7/Tran',
  'Animate Rope:B1/W1/Tran',
  'Antilife Shell:An6/C6/D6/Abju',
  'Antimagic Field:C8/Ma6/Pr6/W6/Abju',
  'Antipathy:D9/W8/Ench',
  'Antiplant Shell:D4/Abju',
  'Arcane Eye:W4/Divi',
  'Arcane Lock:W2/Abju',
  'Arcane Mark:W0/Univ',
  'Arcane Sight:W3/Divi',
  'Astral Projection:C9/Tl9/W9/Necr',
  'Atonement:C5/D5/Abju',
  'Augury:C2/Divi',
  'Awaken:D5/Tran',
  'Baleful Polymorph:D5/W5/Tran',
  'Bane:C1/Ench',
  'Banishment:C6/W7/Abju',
  'Barkskin:D2/Pl2/R2/Tran',
  'Bear\'s Endurance:C2/D2/R2/W2/Tran',
  'Bestow Curse:C3/W4/Necr',
  'Bigby\'s Clenched Fist:St8/W8/Evoc',
  'Bigby\'s Crushing Hand:St9/W9/Evoc',
  'Bigby\'s Forceful Hand:W6/Evoc',
  'Bigby\'s Grasping Hand:St7/W7/Evoc',
  'Bigby\'s Interposing Hand:W5/Evoc',
  'Binding:W8/Ench',
  'Blade Barrier:C6/Go6/Wr6/Evoc',
  'Blasphemy:C7/Ev7/Evoc',
  'Bless:C1/P1/Ench',
  'Bless Water:C1/P1/Tran',
  'Bless Weapon:P1/Tran',
  'Blight:D4/W5/Necr',
  'Blindness/Deafness:B2/C3/W2/Necr',
  'Blink:B3/W3/Tran',
  'Blur:B2/W2/Illu',
  'Break Enchantment:B4/C5/Lu5/P4/W5/Abju',
  'Bull\'s Strength:C2/D2/P2/St2/W2/Tran',
  'Burning Hands:Fi1/W1/Evoc',
  'Call Lightning:D3/Evoc',
  'Call Lightning Storm:D5/Evoc',
  'Calm Animals:An1/D1/R1/Ench',
  'Calm Emotions:B2/C2/La2/Ench',
  'Cat\'s Grace:B2/D2/R2/W2/Tran',
  'Cause Fear:B1/C1/De1/W1/Necr',
  'Chain Lightning:Ai6/W6/Evoc',
  'Changestaff:D7/Tran',
  'Chaos Hammer:Ch4/Evoc',
  'Charm Animal:D1/R1/Ench',
  'Charm Monster:B3/W4/Ench',
  'Charm Person:B1/W1/Ench',
  'Chill Metal:D2/Tran',
  'Chill Touch:W1/Necr',
  'Circle Of Death:W6/Necr',
  'Clairaudience/Clairvoyance:B3/Kn3/W3/Divi',
  'Cloak Of Chaos:C8/Ch8/Abju',
  'Clone:W8/Necr',
  'Cloudkill:W5/Conj',
  'Color Spray:W1/Illu',
  'Command:C1/Ench',
  'Command Plants:D4/Pl4/R3/Tran',
  'Command Undead:W2/Necr',
  'Commune:C5/Divi',
  'Commune With Nature:An5/D5/R4/Divi',
  'Comprehend Languages:B1/C1/W1/Divi',
  'Cone Of Cold:W5/Wa6/Evoc',
  'Confusion:B3/Ty4/W4/Ench',
  'Consecrate:C2/Evoc',
  'Contact Other Plane:W5/Divi',
  'Contagion:C3/Dn3/D3/W4/Necr',
  'Contingency:W6/Evoc',
  'Continual Flame:C3/W2/Evoc',
  'Control Plants:D8/Pl8/Tran',
  'Control Undead:W7/Necr',
  'Control Water:C4/D4/W6/Wa4/Tran',
  'Control Weather:Ai7/C7/D7/W7/Tran',
  'Control Winds:Ai5/D5/Tran',
  'Create Food And Water:C3/Conj',
  'Create Greater Undead:C8/De8/W8/Necr',
  'Create Undead:C6/De6/Ev6/W6/Necr',
  'Create Water:C0/D0/P1/Conj',
  'Creeping Doom:D7/Conj',
  'Crushing Despair:B3/W4/Ench',
  'Cure Critical Wounds:B4/C4/D5/He4/Conj',
  'Cure Light Wounds:B1/C1/D1/He1/P1/R2/Conj',
  'Cure Minor Wounds:C0/D0/Conj',
  'Cure Moderate Wounds:B2/C2/D3/He2/P3/R3/Conj',
  'Cure Serious Wounds:B3/C3/D4/He3/P4/R4/Conj',
  'Curse Water:C1/Necr',
  'Dancing Lights:B0/W0/Evoc',
  'Darkness:B2/C2/W2/Evoc',
  'Darkvision:R3/W2/Tran',
  'Daylight:B3/C3/D3/P3/W3/Evoc',
  'Daze:B0/W0/Ench',
  'Daze Monster:B2/W2/Ench',
  'Death Knell:C2/De2/Necr',
  'Death Ward:C4/De4/D5/P4/Necr',
  'Deathwatch:C1/Necr',
  'Deep Slumber:B3/W3/Ench',
  'Deeper Darkness:C3/Evoc',
  'Delay Poison:B2/C2/D2/P2/R1/Conj',
  'Delayed Blast Fireball:W7/Evoc',
  'Demand:W8/Ench',
  'Desecrate:C2/Ev2/Evoc',
  'Destruction:C7/De7/Necr',
  'Detect Animals Or Plants:D1/R1/Divi',
  'Detect Chaos:C1/Divi',
  'Detect Evil:C1/Divi',
  'Detect Good:C1/Divi',
  'Detect Law:C1/Divi',
  'Detect Magic:B0/C0/D0/W0/Divi',
  'Detect Poison:C0/D0/P1/R1/W0/Divi',
  'Detect Scrying:B4/W4/Divi',
  'Detect Secret Doors:B1/Kn1/W1/Divi',
  'Detect Snares And Pits:D1/R1/Divi',
  'Detect Thoughts:B2/Kn2/W2/Divi',
  'Detect Undead:C1/P1/W1/Divi',
  'Dictum:C7/La7/Evoc',
  'Dimension Door:B4/Tl4/W4/Conj',
  'Dimensional Anchor:C4/W4/Abju',
  'Dimensional Lock:C8/W8/Abju',
  'Diminish Plants:D3/R3/Tran',
  'Discern Lies:C4/P3/Divi',
  'Discern Location:C8/Kn8/W8/Divi',
  'Disguise Self:B1/Ty1/W1/Illu',
  'Disintegrate:Dn7/W6/Tran',
  'Dismissal:C4/W5/Abju',
  'Dispel Chaos:C5/La5/P4/Abju',
  'Dispel Evil:C5/Go5/P4/Abju',
  'Dispel Good:C5/Ev5/Abju',
  'Dispel Law:C5/Ch5/Abju',
  'Dispel Magic:B3/C3/D4/Ma3/P3/W3/Abju',
  'Displacement:B3/W3/Illu',
  'Disrupt Undead:W0/Necr',
  'Disrupting Weapon:C5/Tran',
  'Divination:C4/Kn4/Divi',
  'Divine Favor:C1/P1/Evoc',
  'Divine Power:C4/Wr4/Evoc',
  'Dominate Animal:An3/D3/Ench',
  'Dominate Monster:W9/Ench',
  'Dominate Person:B4/W5/Ench',
  'Doom:C1/Necr',
  'Drawmij\'s Instant Summons:W7/Conj',
  'Dream:B5/W5/Illu',
  'Eagle\'s Splendor:B2/C2/P2/W2/Tran',
  'Earthquake:C8/Dn8/D8/Ea7/Evoc',
  'Elemental Swarm:Ai9/D9/Ea9/Fi9/Wa9/Conj',
  'Endure Elements:C1/D1/P1/R1/Su1/W1/Abju',
  'Energy Drain:C9/W9/Necr',
  'Enervation:W4/Necr',
  'Enlarge Person:St1/W1/Tran',
  'Entangle:D1/Pl1/R1/Tran',
  'Enthrall:B2/C2/Ench',
  'Entropic Shield:C1/Lu1/Abju',
  'Erase:B1/W1/Tran',
  'Ethereal Jaunt:C7/W7/Tran',
  'Etherealness:C9/W9/Tran',
  'Evard\'s Black Tentacles:W4/Conj',
  'Expeditious Retreat:B1/W1/Tran',
  'Explosive Runes:W3/Abju',
  'Eyebite:B6/W6/Necr',
  'Fabricate:W5/Tran',
  'Faerie Fire:D1/Evoc',
  'False Life:W2/Necr',
  'False Vision:B5/Ty5/W5/Illu',
  'Fear:B3/W4/Necr',
  'Feather Fall:B1/W1/Tran',
  'Feeblemind:W5/Ench',
  'Find The Path:B6/C6/D6/Kn6/Tl6/Divi',
  'Find Traps:C2/Divi',
  'Finger Of Death:D8/W7/Necr',
  'Fire Seeds:D6/Fi6/Su6/Conj',
  'Fire Shield:Fi5/Su4/W4/Evoc',
  'Fire Storm:C8/D7/Fi7/Evoc',
  'Fire Trap:D2/W4/Abju',
  'Fireball:W3/Evoc',
  'Flame Arrow:W3/Tran',
  'Flame Blade:D2/Evoc',
  'Flame Strike:C5/D4/Su5/Wr5/Evoc',
  'Flaming Sphere:D2/W2/Evoc',
  'Flare:B0/D0/W0/Evoc',
  'Flesh To Stone:W6/Tran',
  'Fly:Tl3/W3/Tran',
  'Fog Cloud:D2/W2/Wa2/Conj',
  'Forbiddance:C6/Abju',
  'Forcecage:W7/Evoc',
  'Foresight:D9/Kn9/W9/Divi',
  'Fox\'s Cunning:B2/W2/Tran',
  'Freedom:W9/Abju',
  'Freedom Of Movement:B4/C4/D4/Lu4/R4/Abju',
  'Gaseous Form:Ai3/B3/W3/Tran',
  'Gate:C9/W9/Conj',
  'Geas/Quest:B6/C6/W6/Ench',
  'Gentle Repose:C2/W3/Necr',
  'Ghost Sound:B0/W0/Illu',
  'Ghoul Touch:W2/Necr',
  'Giant Vermin:C4/D4/Tran',
  'Glibness:B3/Tran',
  'Glitterdust:B2/W2/Conj',
  'Globe Of Invulnerability:W6/Abju',
  'Glyph Of Warding:C3/Abju',
  'Good Hope:B3/Ench',
  'Goodberry:D1/Tran',
  'Grease:B1/W1/Conj',
  'Greater Arcane Sight:W7/Divi',
  'Greater Command:C5/Ench',
  'Greater Dispel Magic:B5/C6/D6/W6/Abju',
  'Greater Glyph Of Warding:C6/Abju',
  'Greater Heroism:B5/W6/Ench',
  'Greater Invisibility:B4/W4/Illu',
  'Greater Magic Fang:D3/R3/Tran',
  'Greater Magic Weapon:C4/P3/W3/Tran',
  'Greater Planar Ally:C8/Conj',
  'Greater Planar Binding:W8/Conj',
  'Greater Prying Eyes:W8/Divi',
  'Greater Restoration:C7/Conj',
  'Greater Scrying:B6/C7/D7/W7/Divi',
  'Greater Shadow Conjuration:W7/Illu',
  'Greater Shadow Evocation:W8/Illu',
  'Greater Shout:B6/W8/Evoc',
  'Greater Spell Immunity:C8/Abju',
  'Greater Teleport:W7/Tl7/Conj',
  'Guards And Wards:W6/Abju',
  'Guidance:C0/D0/Divi',
  'Gust Of Wind:D2/W2/Evoc',
  'Hallow:C5/D5/Evoc',
  'Hallucinatory Terrain:B4/W4/Illu',
  'Halt Undead:W3/Necr',
  'Harm:C6/Dn6/Necr',
  'Haste:B3/W3/Tran',
  'Heal:C6/D7/He6/Conj',
  'Heal Mount:P3/Conj',
  'Heat Metal:D2/Su2/Tran',
  'Helping Hand:C3/Evoc',
  'Heroes\' Feast:B6/C6/Conj',
  'Heroism:B2/W3/Ench',
  'Hide From Animals:D1/R1/Abju',
  'Hide From Undead:C1/Abju',
  'Hold Animal:An2/D2/R2/Ench',
  'Hold Monster:B4/La6/W5/Ench',
  'Hold Person:B2/C2/W3/Ench',
  'Hold Portal:W1/Abju',
  'Holy Aura:C8/Go8/Abju',
  'Holy Smite:Go4/Evoc',
  'Holy Sword:P4/Evoc',
  'Holy Word:C7/Go7/Evoc',
  'Horrid Wilting:W8/Wa8/Necr',
  'Hypnotic Pattern:B2/W2/Illu',
  'Hypnotism:B1/W1/Ench',
  'Ice Storm:D4/W4/Wa5/Evoc',
  'Identify:B1/Ma2/W1/Divi',
  'Illusionary Script:B3/W3/Illu',
  'Illusionary Wall:W4/Illu',
  'Imbue With Spell Ability:C4/Ma4/Evoc',
  'Implosion:C9/Dn9/Evoc',
  'Imprisonment:W9/Abju',
  'Incendiary Cloud:Fi8/W8/Conj',
  'Inflict Critical Wounds:C4/Dn4/Necr',
  'Inflict Light Wounds:C1/Dn1/Necr',
  'Inflict Minor Wounds:C0/Necr',
  'Inflict Moderate Wounds:C2/Necr',
  'Inflict Serious Wounds:C3/Necr',
  'Insanity:W7/Ench',
  'Insect Plague:C5/D5/Conj',
  'Invisibility:B2/Ty2/W2/Illu',
  'Invisibility Purge:C3/Evoc',
  'Invisibility Sphere:B3/W3/Illu',
  'Iron Body:Ea8/W8/Tran',
  'Ironwood:D6/Tran',
  'Jump:D1/R1/W1/Tran',
  'Keen Edge:W3/Tran',
  'Knock:W2/Tran',
  'Know Direction:B0/D0/Divi',
  'Legend Lore:B4/Kn7/W6/Divi',
  'Leomund\'s Secret Chest:W5/Conj',
  'Leomund\'s Secure Shelter:B4/W4/Conj',
  'Leomund\'s Tiny Hut:B3/W3/Evoc',
  'Leomund\'s Trap:W2/Illu',
  'Lesser Confusion:B1/Ench',
  'Lesser Geas:B3/W4/Ench',
  'Lesser Globe Of Invulnerability:W4/Abju',
  'Lesser Planar Ally:C4/Conj',
  'Lesser Planar Binding:W5/Conj',
  'Lesser Restoration:C2/D2/P1/Conj',
  'Levitate:W2/Tran',
  'Light:B0/C0/D0/W0/Evoc',
  'Lightning Bolt:W3/Evoc',
  'Limited Wish:W7/Univ',
  'Liveoak:D6/Tran',
  'Locate Creature:B4/W4/Divi',
  'Locate Object:B2/C3/Tl2/W2/Divi',
  'Longstrider:D1/R1/Tl1/Tran',
  'Lullaby:B0/Ench',
  'Mage Armor:W1/Conj',
  'Mage Hand:B0/W0/Tran',
  'Magic Circle Against Chaos:C3/La3/P3/W3/Abju',
  'Magic Circle Against Evil:C3/Go3/P3/W3/Abju',
  'Magic Circle Against Good:C3/Ev3/W3/Abju',
  'Magic Circle Against Law:C3/Ch3/W3/Abju',
  'Magic Fang:D1/R1/Tran',
  'Magic Jar:W5/Necr',
  'Magic Missile:W1/Evoc',
  'Magic Mouth:B1/W2/Illu',
  'Magic Stone:C1/D1/Ea1/Tran',
  'Magic Vestment:C3/St3/Wr3/Tran',
  'Magic Weapon:C1/P1/W1/Wr1/Tran',
  'Major Creation:W5/Conj',
  'Major Image:B3/W3/Illu',
  'Make Whole:C2/Tran',
  'Mark Of Justice:C5/P4/Necr',
  'Mass Bear\'s Endurance:C6/D6/W6/Tran',
  'Mass Bull\'s Strength:C6/D6/W6/Tran',
  'Mass Cat\'s Grace:B6/D6/W6/Tran',
  'Mass Charm Monster:B6/W8/Ench',
  'Mass Cure Critical Wounds:C8/D9/He8/Conj',
  'Mass Cure Light Wounds:B5/C5/D6/He5/Conj',
  'Mass Cure Moderate Wounds:B6/C6/D7/Conj',
  'Mass Cure Serious Wounds:C7/D8/Conj',
  'Mass Eagle\'s Splendor:B6/C6/W6/Tran',
  'Mass Enlarge Person:W4/Tran',
  'Mass Fox\'s Cunning:B6/W6/Tran',
  'Mass Heal:C9/He9/Conj',
  'Mass Hold Monster:W9/Ench',
  'Mass Hold Person:W7/Ench',
  'Mass Inflict Critical Wounds:C8/Necr',
  'Mass Inflict Light Wounds:C5/Dn5/Necr',
  'Mass Inflict Moderate Wounds:C6/Necr',
  'Mass Inflict Serious Wounds:C7/Necr',
  'Mass Invisibility:W7/Illu',
  'Mass Owl\'s Wisdom:C6/D6/W6/Tran',
  'Mass Reduce Person:W4/Tran',
  'Mass Suggestion:B5/W6/Ench',
  'Maze:W8/Conj',
  'Meld Into Stone:C3/D3/Tran',
  'Melf\'s Acid Arrow:W2/Conj',
  'Mending:B0/C0/D0/W0/Tran',
  'Message:B0/W0/Tran',
  'Meteor Swarm:W9/Evoc',
  'Mind Blank:Pr8/W8/Abju',
  'Mind Fog:B5/W5/Ench',
  'Minor Creation:W4/Conj',
  'Minor Image:B2/W2/Illu',
  'Miracle:C9/Lu9/Evoc',
  'Mirage Arcana:B5/W5/Illu',
  'Mirror Image:B2/W2/Illu',
  'Misdirection:B2/W2/Illu',
  'Mislead:B5/Lu6/Ty6/W6/Illu',
  'Modify Memory:B4/Ench',
  'Moment Of Prescience:Lu8/W8/Divi',
  'Mordenkainen\'s Disjunction:Ma9/W9/Abju',
  'Mordenkainen\'s Faithful Hound:W5/Conj',
  'Mordenkainen\'s Lucubration:W6/Tran',
  'Mordenkainen\'s Magnificent Mansion:W7/Conj',
  'Mordenkainen\'s Private Sanctum:W5/Abju',
  'Mordenkainen\'s Sword:W7/Evoc',
  'Mount:W1/Conj',
  'Move Earth:D6/W6/Tran',
  'Neutralize Poison:B4/C4/D3/P4/R3/Conj',
  'Nightmare:B5/W5/Illu',
  'Nondetection:R4/Ty3/W3/Abju',
  'Nystul\'s Magic Aura:B1/Ma1/W1/Illu',
  'Obscure Object:B1/C3/W2/Abju',
  'Obscuring Mist:Ai1/C1/D1/W1/Wa1/Conj',
  'Open/Close:B0/W0/Tran',
  'Order\'s Wrath:La4/Evoc',
  'Otiluke\'s Freezing Sphere:W6/Evoc',
  'Otiluke\'s Resilient Sphere:W4/Evoc',
  'Otiluke\'s Telekinetic Sphere:W8/Evoc',
  'Otto\'s Irresistible Dance:B6/W8/Ench',
  'Overland Flight:W5/Tran',
  'Owl\'s Wisdom:C2/D2/P2/R2/W2/Tran',
  'Pass Without Trace:D1/R1/Tran',
  'Passwall:W5/Tran',
  'Permanency:W5/Univ',
  'Permanent Image:B6/W6/Illu',
  'Persistent Image:B5/W5/Illu',
  'Phantasmal Killer:W4/Illu',
  'Phantom Steed:B3/W3/Conj',
  'Phase Door:Tl8/W7/Conj',
  'Planar Ally:C6/Conj',
  'Planar Binding:W6/Conj',
  'Plane Shift:C5/W7/Conj',
  'Plant Growth:D3/Pl3/R3/Tran',
  'Poison:C4/D3/Necr',
  'Polar Ray:W8/Evoc',
  'Polymorph:W4/Tran',
  'Polymorph Any Object:Ty8/W8/Tran',
  'Power Word, Blind:W7/Wr7/Ench',
  'Power Word, Kill:W9/Wr9/Ench',
  'Power Word, Stun:W8/Wr8/Ench',
  'Prayer:C3/P3/Ench',
  'Prestidigitation:B0/W0/Univ',
  'Prismatic Sphere:Pr9/Su9/W9/Abju',
  'Prismatic Spray:W7/Evoc',
  'Prismatic Wall:W8/Abju',
  'Produce Flame:D1/Fi2/Evoc',
  'Programmed Image:B6/W6/Illu',
  'Project Image:B6/W7/Illu',
  'Protection From Arrows:W2/Abju',
  'Protection From Chaos:C1/La1/P1/W1/Abju',
  'Protection From Energy:C3/D3/Lu3/Pr3/R2/W3/Abju',
  'Protection From Evil:C1/Go1/P1/W1/Abju',
  'Protection From Good:C1/Ev1/W1/Abju',
  'Protection From Law:C1/Ch1/W1/Abju',
  'Protection From Spells:Ma8/W8/Abju',
  'Prying Eyes:W5/Divi',
  'Purify Food And Drink:C0/D0/Tran',
  'Pyrotechnics:B2/W2/Tran',
  'Quench:D3/Tran',
  'Rage:B2/W3/Ench',
  'Rainbow Pattern:B4/W4/Illu',
  'Raise Dead:C5/Conj',
  'Rary\'s Mnemonic Enhancer:W4/Tran',
  'Rary\'s Telepathic Bond:W5/Divi',
  'Ray Of Enfeeblement:W1/Necr',
  'Ray Of Exhaustion:W3/Necr',
  'Ray Of Frost:W0/Evoc',
  'Read Magic:B0/C0/D0/P1/R1/W0/Divi',
  'Reduce Animal:D2/R3/Tran',
  'Reduce Person:W1/Tran',
  'Refuge:C7/W9/Conj',
  'Regenerate:C7/D9/He7/Conj',
  'Reincarnate:D4/Tran',
  'Remove Blindness/Deafness:C3/P3/Conj',
  'Remove Curse:B3/C3/P3/W4/Abju',
  'Remove Disease:C3/D3/R3/Conj',
  'Remove Fear:B1/C1/Abju',
  'Remove Paralysis:C2/P2/Conj',
  'Repel Metal Or Stone:D8/Abju',
  'Repel Vermin:B4/C4/D4/R3/Abju',
  'Repel Wood:D6/Pl6/Tran',
  'Repulsion:C7/Pr7/W6/Abju',
  'Resist Energy:C2/D2/Fi3/P2/R1/W2/Abju',
  'Resistance:B0/C0/D0/P1/W0/Abju',
  'Restoration:C4/P4/Conj',
  'Resurrection:C7/Conj',
  'Reverse Gravity:D8/W7/Tran',
  'Righteous Might:C5/St5/Tran',
  'Rope Trick:W2/Tran',
  'Rusting Grasp:D4/Tran',
  'Sanctuary:C1/Pr1/Abju',
  'Scare:B2/W2/Necr',
  'Scintillating Pattern:W8/Illu',
  'Scorching Ray:W2/Evoc',
  'Screen:Ty7/W8/Illu',
  'Scrying:B3/C5/D4/W4/Divi',
  'Sculpt Sound:B3/Tran',
  'Searing Light:C3/Su3/Evoc',
  'Secret Page:B3/W3/Tran',
  'See Invisibility:B3/W2/Divi',
  'Seeming:B5/W5/Illu',
  'Sending:C4/W5/Evoc',
  'Sepia Snake Sigil:B3/W3/Conj',
  'Sequester:W7/Abju',
  'Shades:W9/Illu',
  'Shadow Conjuration:B4/W4/Illu',
  'Shadow Evocation:B5/W5/Illu',
  'Shadow Walk:B5/W6/Illu',
  'Shambler:D9/Pl9/Conj',
  'Shapechange:An9/D9/W9/Tran',
  'Shatter:B2/C2/Ch2/Dn2/W2/Evoc',
  'Shield:W1/Abju',
  'Shield Of Faith:C1/Abju',
  'Shield Of Law:C8/La8/Abju',
  'Shield Other:C2/P2/Pr2/Abju',
  'Shillelagh:D1/Tran',
  'Shocking Grasp:W1/Evoc',
  'Shout:B4/W4/Evoc',
  'Shrink Item:W3/Tran',
  'Silence:B2/C2/Illu',
  'Silent Image:B1/W1/Illu',
  'Simulacrum:W7/Illu',
  'Slay Living:C5/De5/Necr',
  'Sleep:B1/W1/Ench',
  'Sleet Storm:D3/W3/Conj',
  'Slow:B3/W3/Tran',
  'Snare:D3/R2/Tran',
  'Soften Earth And Stone:D2/Ea2/Tran',
  'Solid Fog:W4/Conj',
  'Song Of Discord:B5/Ench',
  'Soul Bind:C9/W9/Necr',
  'Sound Burst:B2/C2/Evoc',
  'Speak With Animals:B3/D1/R1/Divi',
  'Speak With Dead:C3/Necr',
  'Speak With Plants:B4/D3/R2/Divi',
  'Spectral Hand:W2/Necr',
  'Spell Immunity:C4/Pr4/St4/Abju',
  'Spell Resistance:C5/Ma5/Pr5/Abju',
  'Spell Turning:Lu7/Ma7/W7/Abju',
  'Spellstaff:D6/Tran',
  'Spider Climb:D2/W2/Tran',
  'Spike Growth:D3/R2/Tran',
  'Spike Stones:D4/Ea4/Tran',
  'Spiritual Weapon:C2/Wr2/Evoc',
  'Statue:W7/Tran',
  'Status:C2/Divi',
  'Stinking Cloud:W3/Conj',
  'Stone Shape:C3/D3/Ea3/W5/Tran',
  'Stone Tell:D6/Divi',
  'Stone To Flesh:W6/Tran',
  'Stoneskin:D5/Ea6/St6/W4/Abju',
  'Storm Of Vengeance:C9/D9/Conj',
  'Suggestion:B2/W3/Ench',
  'Summon Instrument:B0/Conj',
  'Summon Monster I:B1/C1/W1/Conj',
  'Summon Monster II:B2/C2/W2/Conj',
  'Summon Monster III:B3/C3/W3/Conj',
  'Summon Monster IV:B4/C4/W4/Conj',
  'Summon Monster IX:C9/Ch9/Ev9/Go9/La9/W9/Conj',
  'Summon Monster V:B5/C5/W5/Conj',
  'Summon Monster VI:B6/C6/W6/Conj',
  'Summon Monster VII:C7/W7/Conj',
  'Summon Monster VIII:C8/W8/Conj',
  'Summon Nature\'s Ally I:D1/R1/Conj',
  'Summon Nature\'s Ally II:D2/R2/Conj',
  'Summon Nature\'s Ally III:D3/R3/Conj',
  'Summon Nature\'s Ally IV:An4/D4/R4/Conj',
  'Summon Nature\'s Ally IX:D9/Conj',
  'Summon Nature\'s Ally V:D5/Conj',
  'Summon Nature\'s Ally VI:D6/Conj',
  'Summon Nature\'s Ally VII:D7/Conj',
  'Summon Nature\'s Ally VIII:An8/D8/Conj',
  'Summon Swarm:B2/D2/W2/Conj',
  'Sunbeam:D7/Su7/Evoc',
  'Sunburst:D8/Su8/W8/Evoc',
  'Symbol Of Death:C8/W8/Necr',
  'Symbol Of Fear:C6/W6/Necr',
  'Symbol Of Insanity:C8/W8/Ench',
  'Symbol Of Pain:C5/W5/Necr',
  'Symbol Of Persuasion:C6/W6/Ench',
  'Symbol Of Sleep:C5/W5/Ench',
  'Symbol Of Stunning:C7/W7/Ench',
  'Symbol Of Weakness:C7/W7/Necr',
  'Sympathetic Vibration:B6/Evoc',
  'Sympathy:D9/W8/Ench',
  'Tasha\'s Hideous Laughter:B1/W2/Ench',
  'Telekinesis:W5/Tran',
  'Teleport:Tl5/W5/Conj',
  'Teleport Object:W7/Conj',
  'Teleportation Circle:W9/Conj',
  'Temporal Stasis:W8/Tran',
  'Tenser\'s Floating Disk:W1/Evoc',
  'Tenser\'s Transformation:W6/Tran',
  'Time Stop:Ty9/W9/Tran',
  'Tongues:B2/C4/W3/Divi',
  'Touch Of Fatigue:W0/Necr',
  'Touch Of Idiocy:W2/Ench',
  'Transmute Metal To Wood:D7/Tran',
  'Transmute Mud To Rock:D5/W5/Tran',
  'Transmute Rock To Mud:D5/W5/Tran',
  'Transport Via Plants:D6/Tran',
  'Trap The Soul:W8/Conj',
  'Tree Shape:D2/R3/Tran',
  'Tree Stride:D5/R4/Conj',
  'True Resurrection:C9/Conj',
  'True Seeing:C5/D7/Kn5/W6/Divi',
  'True Strike:W1/Divi',
  'Undeath To Death:C6/W6/Necr',
  'Undetectable Alignment:B1/C2/P2/Abju',
  'Unhallow:C5/D5/Evoc',
  'Unholy Aura:C8/Ev8/Abju',
  'Unholy Blight:Ev4/Evoc',
  'Unseen Servant:B1/W1/Conj',
  'Vampiric Touch:W3/Necr',
  'Veil:B6/W6/Illu',
  'Ventriloquism:B1/W1/Illu',
  'Virtue:C0/D0/P1/Tran',
  'Vision:W7/Divi',
  'Wail Of The Banshee:De9/W9/Necr',
  'Wall Of Fire:D5/Fi4/W4/Evoc',
  'Wall Of Force:W5/Evoc',
  'Wall Of Ice:W4/Evoc',
  'Wall Of Iron:W6/Conj',
  'Wall Of Stone:C5/D6/Ea5/W5/Conj',
  'Wall Of Thorns:D5/Pl5/Conj',
  'Warp Wood:D2/Tran',
  'Water Breathing:C3/D3/Wa3/W3/Tran',
  'Water Walk:C3/R3/Tran',
  'Waves Of Exhaustion:W7/Necr',
  'Waves Of Fatigue:W5/Necr',
  'Web:W2/Conj',
  'Weird:W9/Illu',
  'Whirlwind:Ai8/D8/Evoc',
  'Whispering Wind:B2/W2/Tran',
  'Wind Walk:C6/D7/Tran',
  'Wind Wall:Ai2/C3/D3/R2/W3/Evoc',
  'Wish:W9/Univ',
  'Wood Shape:D2/Tran',
  'Word Of Chaos:C7/Ch7/Evoc',
  'Word Of Recall:C6/D8/Conj',
  'Zone Of Silence:B4/Illu',
  'Zone Of Truth:C2/P2/Ench'
];
PH35.WEAPONS = [
...
PH35.magicRules = function(rules) {
  ...
  rules.defineChoice('spells', PH35.SPELLS);
...
PH35.randomize = function(rules, attributes, attribute) {
  ...
  if(abilities[attribute] != null) {
    ...
    if(attributes['levels.Wizard'] != null) {
      var specialty = ScribeUtils.randomKey(rules.getChoices('schools'));
