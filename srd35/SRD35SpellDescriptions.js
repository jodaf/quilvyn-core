...
SRD35SpellDescriptions.descriptions = {
  "Acid Arrow": "R$RL' touch 2d4 HP/rd for ${1 + Math.floor(lvl/3)} rd",
  "Acid Fog": "R$RM' 20' fog cylinder 2d6 HP/rd for $L rd",
  "Acid Splash": "R$RS' touch 1d3 HP",
  ...
  "Alter Self": "Become small (+2 Dex) or medium (+2 Str) humanoid for $L min",
  "Analyze Dweomer": "R$RS' Will save or reveals magical aspects for $L rd",
  ...
  "Animal Shapes": "R$RS' $L allies become chosen animal for $L hr",
  ...
  "Comprehend Languages": "Understand all languages for $L10 min",
  ...
  "Continual Flame": "Permanent, heatless torch flame",
  ...
  "Daze": "R$RS' Humanoid le 4 HD Will save or lose next action",
  "Daze Monster": "R$RM' Creature le 6 HD Will save or lose next action",
  ...
  "Detect Magic": "R60' cone Info on magical auras for $L10 min",
  ...
  "Disguise Self": "Change your appearance/+10 disguise for $L10 min",
  ...
  "Greater Magic Fang": "R$RS' target natural weapon +${1+Math.min(Math.floor(lvl/4),4)} attack/damage for $L hr",
  "Greater Magic Weapon": "R$RS' target weapon +${1+Math.min(Math.floor(lvl/4),4)} attack/damage for $L hr",
  ...
  "Mage Hand": "R$RS' 5 lb telekinesis move 30'",
  ...
  "Magic Vestment": "Touched armor/shield/clothing +${Math.min(Math.floor((lvl+4)/4),5)} AC for $L hr",
  ...
  "Open/Close": "R$RS' Opens/closes target le 30 lb",
  ...
  "Protection From Energy": "Absorb damage from specified energy for $L10 min/${Math.min(lvl*12,120)} HP",
  ...
  "Summon Monster II": "R$RS' 1/1d3 2nd/1st-level creature appears, fights foes for $L rd",
  "Summon Monster III": "R$RS' 1/1d3/1d4+1 3rd/2nd/1st-level creature appears, fights foes for $L rd",
  "Summon Monster IV": "R$RS' 1/1d3/1d4+1 4th/3rd/lower creature appears, fights foes for $L rd",
  "Summon Monster V": "R$RS' 1/1d3/1d4+1 5th/4th/lower creature appears, fights foes for $L rd",
  "Summon Monster VI": "R$RS' 1/1d3/1d4+1 6th/5th/lower creature appears, fights foes for $L rd",
  "Summon Monster VII": "R$RS' 1/1d3/1d4+1 7th/6th/lower creature appears, fights foes for $L rd",
  "Summon Monster VIII": "R$RS' 1/1d3/1d4+1 8th/7th/lower creature appears, fights foes for $L rd",
  "Summon Monster IX": "R$RS' 1/1d3/1d4+1 9th/8th/lower creature appears, fights foes for $L rd",
  "Summon Nature's Ally I": "R$RS' 1 1st-level creature appears, fights foes for $L rd",
  "Summon Nature's Ally II": "R$RS' 1/1d3 2nd/1st-level creature appears, fights foes for $L rd",
  "Summon Nature's Ally III": "R$RS' 1/1d3/1d4+1 3rd/2nd/1st-level creature appears, fights foes for $L rd",
  "Summon Nature's Ally IV": "R$RS' 1/1d3/1d4+1 4th/3rd/lower creature appears, fights foes for $L rd",
  "Summon Nature's Ally V": "R$RS' 1/1d3/1d4+1 5th/4th/lower creature appears, fights foes for $L rd",
  "Summon Nature's Ally VI": "R$RS' 1/1d3/1d4+1 6th/5th/lower creature appears, fights foes for $L rd",
  "Summon Nature's Ally VII": "R$RS' 1/1d3/1d4+1 7th/6th/lower creature appears, fights foes for $L rd",
  "Summon Nature's Ally VIII": "R$RS' 1/1d3/1d4+1 8th/7th/lower creature appears, fights foes for $L rd",
  "Summon Nature's Ally IX": "R$RS' 1/1d3/1d4+1 9th/8th/lower creature appears, fights foes for $L rd",
