...
SRD35.spellsDescriptions = {
  ...
  "Binding": "R$RS' Target magically imprisoned (Will neg (min $Ldev2 HD))",
  ...
  "Clenched Fist": "R$RM' 10' (AC 20, caster HP) hand cover (+4 AC), move 60', hit (+$L+mod for 1d8+11, stunned 1 rd (Fort neg)), bull rush (CMB ${lvl + 12}) for $L rd",
  ...
  "Disintegrate": "R$RM' Target ${Math.min(lvl*2,40)}d6 HP (Fort half), dust if slain (Fort 5d6)",
  ...
  "Glyph Of Warding": "Proscribed creatures passing $L5 sq' area trigger ${1+Math.max(Math.floor(lvl/2),5)}d8 blast (Ref half) or harmful spell le 3rd level",
  ...
  "Greater Glyph Of Warding": "Proscribed creatures passing $L5 sq' area trigger ${1+Math.max(Math.floor(lvl/2),10)}d8 blast (Ref half) or harmful spell le 6th level",
  ...
  "Greater Planar Binding": "Extraplanar creature(s) le 18 HD trapped until escape (DC ${Math.floor(lvl/2)+15}+cha) or performs a task (Will neg)",
  ...
  "Lesser Planar Binding": "Extraplanar creature le 6 HD trapped until escape (DC ${Math.floor(lvl/2)+15}+cha) or performs a task (Will neg)",
  ...
  "Planar Binding": "Extraplanar creature(s) le 12 HD trapped until escape (DC ${Math.floor(lvl/2)+15}+cha) or performs a task (Will neg)",
  ...
  "Ray Of Enfeeblement": "R$RS' Ranged touch 1d6+${Math.min(Math.floor(lvl/2),5)} Str",
  ...
  "Telekinesis": "R$RL' Move ${Math.min(lvl*25,375)} lb 20' for $L rd, combat maneuver (CMB $L) $L rd, or hurl ${Math.min(lvl,15)} objects ${Math.min(lvl*25,375)} lbs total (Will neg)",
  ...
  "Wood Shape": "Shape ${10+lvl}' cu of wood (Will neg)",
