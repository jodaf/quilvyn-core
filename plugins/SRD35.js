...
function SRD35() {
  ...
  for(var klass in SRD35.CLASSES) {
    SRD35.choiceRules(rules, 'classes', klass, SRD35.CLASSES[klass]);
  }
 ...
 * TODO
 */
SRD35.classRules = function(rules, name) {
  ...
  SRD35.defineClass
    (rules, name, hitDie, skillPoints, baseAttack, saveFortitude, saveReflex,
